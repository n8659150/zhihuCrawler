...
class zhihuCrawler {
  ...
  async getQuestion() {
    let uri = `https://www.zhihu.com/api/v4/questions/${this.questionId}`;
    let response = {};
    try {
      response = await rp({ uri, json: true, timeout: 5000 });
    } catch (error) {
